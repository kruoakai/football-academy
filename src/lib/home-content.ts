...
export const HOME_VISIBILITY_FIELDS = [
  ...
  "showUspSection",
  "showUspSectionTitle",
  "showUspSectionSubtitle",
  "showUsp1",
  "showUsp2",
  "showHighlightsSection",
  "showHighlightsSectionTitle",
  "showHighlight1",
  "showHighlight2",
  "showHighlight3",
  "showProgramsSection",
  "showProgramsSectionTitle",
  "showProgramsSectionSubtitle",
  "showProgram1",
  "showProgram2",
  "showProgram3",
  "showArticlesSection",
...
export const DEFAULT_HOME_CONTENT: HomeContent = {
  ...
  showHeroChip3: true,
  showUspSection: true,
  showUspSectionTitle: true,
  showUspSectionSubtitle: true,
  showUsp1: true,
  showUsp2: true,
  showHighlightsSection: true,
  showHighlightsSectionTitle: true,
  showHighlight1: true,
  showHighlight2: true,
  showHighlight3: true,
  showProgramsSection: true,
  showProgramsSectionTitle: true,
  showProgramsSectionSubtitle: true,
  showProgram1: true,
  showProgram2: true,
  showProgram3: true,
